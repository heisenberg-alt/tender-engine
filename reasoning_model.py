...
def reasoning_model_page():
    """
    Reasoning Model page with file uploader and text input field
    """
    st.header("🧠 Reasoning Model")
    st.markdown("Upload documents and provide input for AI-powered reasoning and analysis.")
...
Your output should include a matching score from 0% to 100% for each company, and a brief justification for the score.""",
        ...
        with col_btn1:
            if st.button("🚀 Process with AI", type="primary", use_container_width=True):
                ...
                elif not (company_profile_json or developer_message):
                    st.warning("⚠️ Please provide company profile data or system instructions.")
...
# Run the page function if this file is executed directly
if __name__ == "__main__":
    st.set_page_config(
        page_title="Reasoning Model - Tender Engine",
        page_icon="🧠",
        layout="wide",
        initial_sidebar_state="expanded"
    )
    
    # Add title and description for standalone app
    st.title("🧠 AI Reasoning Model")
    st.markdown("### Intelligent Document Analysis & Reasoning Engine")
    st.markdown("Upload documents and leverage Azure Document Intelligence for advanced analysis and insights.")
    
    # Run the main page function
    reasoning_model_page()